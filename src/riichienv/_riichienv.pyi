...
class CalcError(ValueError):
    code: str
    details: str
def calculate_shanten34(counts34: list[int], meld_count: int, unavailable_counts34: list[int], variant: str, contract_version: str) -> str: ...
def analyze_draws34(counts34: list[int], meld_count: int, unavailable_counts34: list[int], variant: str, contract_version: str) -> str: ...
def analyze_discards34(counts34: list[int], meld_count: int, unavailable_counts34: list[int], variant: str, contract_version: str) -> str: ...
